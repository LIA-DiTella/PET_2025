...
def plot_data(config_path, gpu_id=None):
    ...
    def plot_histogram(images, title, ax):
        ...
        stats_text = f"Media: {mean_val:.3f}\nDesv.Est: {std_val:.3f}\nRango: [{min_val:.3f}, {max_val:.3f}]"
    ...
    fig.suptitle('Distribución de Intensidades de Píxeles en Datasets', fontsize=16, fontweight='bold')
    ...
    fig, axs = plt.subplots(3, 1, figsize=(12, 16))
    fig.suptitle('Distribución de Intensidades de Píxeles (Escala Logarítmica)', fontsize=16, fontweight='bold')
    ...
    def prepare_comparison_data(train, val, test, max_samples=10000):
        ...
        data = pd.DataFrame({
            ...
            'dataset': (['Entrenamiento'] * len(train_clean) + 
    ...
    sns.histplot(data=comparison_data, x='intensity', hue='dataset', 
    ...
    fig, axs = plt.subplots(3, 1, figsize=(12, 16))
    fig.suptitle('Distribución de Intensidades de Píxeles (Excluyendo Ceros)', fontsize=16, fontweight='bold')
    ...
    fig, axs = plt.subplots(3, 1, figsize=(12, 16))
    fig.suptitle('Distribución de Intensidades (Escala Log, Sin Ceros)', fontsize=16, fontweight='bold')
